...
export function collapseTemplateValue(value: TemplateValue): PropValue {
  if (value.some(seg => typeof seg !== 'string')) return { kind: 'template', value }
 ...
 */
export function interpolatablesFromDefinitions(defs: PropDefinition[]): InterpolatableIdentifier[] {
