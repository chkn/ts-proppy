 ...
 * choices.
 */
export function ComboboxEditor({ value, onChange, propDef, unionInfo, className, disabled }: ComboboxEditorProps) {
  const text = value?.kind === 'primitive' && typeof value.value === 'string' ? value.value : ''
